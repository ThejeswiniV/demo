...
app.config["SQLALCHEMY_DATABASE_URI"] = "mysql+pymysql://gwcuser:gwcuser@35.200.135.99/database"
engine = create_engine('mysql+pymysql://gwcuser:gwcuser@35.200.135.99/database')
db = SQLAlchemy(app)
