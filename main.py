...
app.config["SQLALCHEMY_DATABASE_URI"] = "mysql+pymysql://gwc2023:gwc2023@35.200.250.135/gwcpmp"
engine = create_engine("mysql+pymysql://gwc2023:gwc2023@35.200.250.135/gwcpmp")
db = SQLAlchemy(app)
